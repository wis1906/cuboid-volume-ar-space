...
#define DEFINE_KDTREE_BASENODETYPES(_Base_)                  \
     ...
     */
        ...
        public:
            ...
            void filter(Container& points, const AABB<Dim>& aabb, Container& output, std::vector<int>& outputIdx, bool invert = false)
		{
