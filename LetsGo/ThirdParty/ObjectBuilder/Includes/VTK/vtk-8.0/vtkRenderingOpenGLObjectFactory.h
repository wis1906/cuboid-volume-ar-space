...
public:
  ...
  const char * GetDescription() VTK_OVERRIDE { return "vtkRenderingOpenGL factory overrides."; }
...
private:
  vtkRenderingOpenGLObjectFactory(const vtkRenderingOpenGLObjectFactory&) VTK_DELETE_FUNCTION;
  void operator=(const vtkRenderingOpenGLObjectFactory&) VTK_DELETE_FUNCTION;
};
